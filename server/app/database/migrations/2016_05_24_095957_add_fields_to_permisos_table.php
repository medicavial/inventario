...
class AddFieldsToPermisosTable extends Migration {
	...
	public function up()
	{
		Schema::table('permisos', function(Blueprint $table)
		{
			...
			$table->boolean('PER_generarOrden')->after('PER_cerrarOrden')->default(false);
			...
			$table->renameColumn('PER_salidas', 'PER_movimientos');
			$table->renameColumn('PER_autorizaOrden', 'PER_generarOrden');
			$table->renameColumn('PER_surtir', 'PER_surtitOrden');
	...
	public function down()
	{
		Schema::table('permisos', function(Blueprint $table)
		{
			...
			$table->dropColumn('PER_generarOrden');
			...
			$table->renameColumn('PER_movimientos','PER_salidas');
			$table->renameColumn('PER_generarOrden','PER_autorizaOrden');
			$table->renameColumn('PER_surtitOrden','PER_surtir');
