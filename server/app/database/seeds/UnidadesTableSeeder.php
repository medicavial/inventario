...
class UnidadesTableSeeder extends Seeder {
    ...
    public function run()
    {
    	...
    	Unidad::create(array(
            ...
            'UNI_correo' => 'salcala@medicavial.com.mx',
            'UNI_horaentrega' => 'L-V 9:00 am a 6:00 pm',
            'UNI_direccion' => 'Av. Alvaro Obregon 121, CP: 06700, Col. Roma',
            'UNI_responsable' => 'Erick Besies',
            'UNI_claveMV' => 33
        ));
        Unidad::create(array(
